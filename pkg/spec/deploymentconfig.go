...
//TODO: implement deploymentconfig specific stuff
...
// Transform function if given DeploymentConfigSpecMod data creates the versioned
// kubernetes objects and returns them in list of runtime.Object
// And if the field in DeploymentConfigSpecMod called 'extraResources' is used
...
func (deployment *DeploymentConfigSpecMod) createK8sController() (*ext_v1beta1.Deployment, error) {
