...
// https://github.com/openshift/origin/blob/master/pkg/apps/apis/apps/v1/types.go
//
// In order to work-around vendoring issues with conflicting files from
// client-go, apimachinery as well as kubernetes/kubernetes, creating hack/openshift/types.go
// was required.
//
// This file also reduces the binary size by explictly supplying the required structs rather
// than fully importing openshift/origin
//
// Included in this file is the addition of:
// func (obj *DeploymentConfig) GetObjectKind() schema.ObjectKind { return &obj.TypeMeta }
// in order to retrieve a runtime.Object type from DeploymentConfig

package v1

import (
	"fmt"
	kapi "github.com/kedgeproject/kedge/pkg/hack/kubernetes"
